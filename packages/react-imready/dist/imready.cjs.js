...
function useImReady(props) {
  ...
  var _h = __read(react.useState(0), 2),
      readyCount = _h[0],
      setReadyCount = _h[1];

  var _j = __read(react.useState(0), 2),
      errorCount = _j[0],
      setErrorCount = _j[1];

  var _k = __read(react.useState(0), 2),
      totalErrorCount = _k[0],
      setTotalErrorCount = _k[1];

  var _l = __read(react.useState(0), 2),
      totalCount = _l[0],
      setTotalCount = _l[1];

  var _m = __read(react.useState(false), 2),
      isPreReady = _m[0],
      setIsPreReady = _m[1];

  var _o = __read(react.useState(false), 2),
      isReady = _o[0],
      setIsReady = _o[1];

  var _p = __read(react.useState(false), 2),
      hasError = _p[0],
      setHasError = _p[1];
